...
signals:
    ...
    void sentData(QByteArray array );//向scoket发送消息
    void sentData(int ,QByteArray);//向scoket发送消息
...
signals:
     void  connectToSystem(int,int );
     void  fangzhenAGVxinxi(int,char,QByteArray);

public slots:
     void receviedFormAGV(int,QByteArray);
